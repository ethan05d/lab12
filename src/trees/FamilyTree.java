...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Invalid line with no colon");
		...
		else
		{
			...
			if (parentNode == null) throw new TreeException("Parent node could not be found");
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException(name1 + " could not be found");
		TreeNode node2 = root.getNodeWithName(name2);
		if (node2 == null)
			throw new TreeException(name2 + " could not be found");
